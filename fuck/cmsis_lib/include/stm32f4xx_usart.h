...
// Function to send 1 char
void usart_putc(USART_TypeDef* USARTx, char c);
// Function to send string
void usart_puts(USART_TypeDef* USARTx, char* c);

void usart_putint(USART_TypeDef* USARTx, int value, int radix);

void usart_putlong(USART_TypeDef* USARTx, int value, int radix);
void usart_putfloat(USART_TypeDef* USARTx, double value);
